...
![](img/03-workflow-manager/ioannidis-reproducibility-crisis.png)
...
![](img/03-workflow-manager/galaxy-workflow-editor.png)
...
![](img/03-workflow-manager/snakemake-idea.png)
